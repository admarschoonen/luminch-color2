...
//#define DS_SENSOR DS_SENSOR_HC_SR04
...
#define DS_INFINITY 750
#endif
#if (DS_SENSOR == DS_SENSOR_HC_SR04)
#define DS_CLOSEST 150
#define DS_FARTHEST 400
#define DS_INFINITY 1000
#endif
...
#define LED_N_LEDS_INNER	16
#define LED_N_LEDS_OUTER	24
#define LED_N_LEDS		(LED_N_LEDS_INNER + LED_N_LEDS_OUTER)
