...
void cs_Lab_move_towards_white_with_fixed_L(cs_Lab_t *Lab_new, float dist)
{
...
void cs_print_RGB(cs_RGB_t *RGB)
{
  ...
  Serial.print(", B: ");
  Serial.print((int) (100 * RGB->B), DEC);
}

void cs_print_linear(cs_linear_t *RGB)
{
  Serial.print(";   r: ");
  Serial.print((int) (100 * RGB->r), DEC);
  Serial.print(", g: ");
...
void cs_print_XYZ(cs_XYZ_t *XYZ)
{
  ...
  Serial.print(", Z: ");
  Serial.print((int) (100 * XYZ->Z), DEC);
}
...
void cs_print_Lab(cs_Lab_t *Lab)
{
  ...
  Serial.print(", b: ");
  Serial.print((int) (100 * Lab->b), DEC);
}
