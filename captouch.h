...
//#define CAP_THRESHOLD_RELEASED_TO_PRESSED(x) (x == 0 ? 14 : (x == 1 ? 20 : (x == 2 ? 10 : 10)))
//#define CAP_THRESHOLD_PRESSED_TO_RELEASED(x) (x == 0 ? 14 : (x == 1 ? 20 : (x == 2 ? 10 : 10)))

//#define CAP_THRESHOLD_RED    14
#define CAP_THRESHOLD_RED    50
//#define CAP_THRESHOLD_GREEN  20
#define CAP_THRESHOLD_GREEN  35
//#define CAP_THRESHOLD_BLUE   10
#define CAP_THRESHOLD_BLUE   20
//#define CAP_THRESHOLD_WHITE  10
#define CAP_THRESHOLD_WHITE  45

#define CAP_THRESHOLD_RELEASED_TO_PRESSED(x) \
  (x == 0 ? CAP_THRESHOLD_RED : (x == 1 ? CAP_THRESHOLD_GREEN : (x == 2 ? CAP_THRESHOLD_BLUE : CAP_THRESHOLD_WHITE)))
#define CAP_THRESHOLD_PRESSED_TO_RELEASED(x) \
  (x == 0 ? CAP_THRESHOLD_RED : (x == 1 ? CAP_THRESHOLD_GREEN : (x == 2 ? CAP_THRESHOLD_BLUE : CAP_THRESHOLD_WHITE)))
